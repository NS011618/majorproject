...
def train_evaluate_predict(selected_algorithm, symptoms):
    try:
        ...
        # Load testing data
        tr = pd.read_csv(r"C:\Users\NANIS\OneDrive\Desktop\project\server\Testing_Predict.csv")
        ...
        # Load training data
        df = pd.read_csv(r"C:\Users\NANIS\OneDrive\Desktop\project\server\Training_Predict.csv")
