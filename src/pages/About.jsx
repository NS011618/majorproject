  ...
  const contentData = [
    {
      title: "About Us",
      image: aboutImage,
      content: "Welcome to our healthcare website! We are dedicated to providing high-quality medical services. Our team of experienced healthcare professionals is committed to ensuring the well-being of our community."
    },
    {
      title: "Our Values",
      image: valuesImage,
  ...
  return (
    <div className="bg-white shadow-md p-8 flex flex-wrap">
      ...
      <div className="w-full mb-8 text-center">
        <p className="text-sm text-gray-500">For more information, contact us at example@gmail.com</p>
      </div>
    </div>
  );
}
